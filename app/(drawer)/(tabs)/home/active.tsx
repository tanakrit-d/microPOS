...
import { ClearButton, SubmitButton, AlertConfirmation } from '@/components/ActiveOrder';
        ...
        <View style={styles.itemContainer}>
            ...
            <View style={styles.quantityContainer}>
                <View style={{ paddingRight: 10 }}>
                    <Pressable onPress={() => { reduceItem(item); triggerUpdate(item.id) }} style={styles.quantityButtonRemove}>
                        <Svg width={12}
                            height={12}
                            fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#FFFFFF">
                ...
                <View style={{ paddingLeft: 10 }}>
                    <Pressable onPress={() => { addItem(item); triggerUpdate(item.id) }} style={styles.quantityButtonAdd}>
                        <Svg width={12}
                            height={12}
                            fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#FFFFFF">
