...
import { StyleSheet, View, ViewProps, Text, Image, useWindowDimensions, Alert, Pressable } from 'react-native';
...
function MainScreen() {
    ...
    return (
        <View style={styles.container}>
            <RenderMenuList listData={food} numColumns={numColumns} tabBarHeight={tabBarHeight} />
        </View>
    )
}
...
function SideScreen() {
    ...
    return (
        <View style={styles.container}>
            <RenderMenuList listData={sides} numColumns={numColumns} tabBarHeight={tabBarHeight} />
        </View>
    )
}
...
function DrinksScreen() {
    ...
    return (
        <View style={styles.container}>
            <RenderMenuList listData={drinks} numColumns={numColumns} tabBarHeight={tabBarHeight} />
        </View>
    )
}
...
function DessertScreen() {
    ...
    return (
        <View style={styles.container}>
            <RenderMenuList listData={dessert} numColumns={numColumns} tabBarHeight={tabBarHeight} />
        </View>
    )
}
