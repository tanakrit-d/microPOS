...
export const AlertConfirmation = (props: AlertConfirmationProps) => {
  ...
  Alert.alert(messageTitle, messageBody, [
    ...
    { text: optionRight, onPress: onPressRight, style: optionRightStyle },
  ]);
};
...
export const ClearButton = (props: OrderButtonProps) => {
  ...
  return (
    <Pressable
      onPress={onPress}
      disabled={disabled}
      style={[styles.buttonClear, disabled && styles.buttonClearDisabled]}
    >
      <Ionicons
        name="trash-bin-outline"
        style={[
          styles.buttonClearText,
          disabled && styles.buttonClearTextDisabled,
        ]}
      ></Ionicons>
    </Pressable>
  );
    ...
    >
      <Text
        style={[
          ...
          disabled && styles.buttonSubmitTextDisabled,
        ]}
      >
        Submit
      </Text>
