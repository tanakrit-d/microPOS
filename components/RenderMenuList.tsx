...
const RenderMenuList: React.FC<RenderMenuListProps> = ({ listData, numColumns = 3, tabBarHeight = 0 }) => {
    ...
    const setTriggerUpdate = useListUpdateStore(state => state.setTriggerUpdate);
    ...
    const renderItem: ListRenderItem<Item> = useCallback(({ item }) => {
        ...
        return (
            ...
            >
                ...
                >
                    <Pressable onPress={() => { addItem(item); updateItem(item.id); }}>
