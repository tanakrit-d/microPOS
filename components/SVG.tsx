...
export function ProtocolLogo({
  ...
  return (
    <Svg height={height} width={width} viewBox="-1.9956 0.7926 22.22 21.93">
      <Path
        fill={colour}
        d="M16 8A5 5 90 0011 3H5A5 5 90 000 8V21.927A1 1 90 001.623 22.709L5.307 19.779A4 4 90 017.797 18.909H11A5 5 90 0016 13.909V8Z"
      />
    </Svg>
  );
}
